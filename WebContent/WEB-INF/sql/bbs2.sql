...
- 서브쿼리를 이용한 레코드 추가 
INSERT INTO bbs2(bbsno, wname, title, content, passwd, wdate, grpno)  
VALUES((SELECT NVL(MAX(bbsno), 0) + 1 as bbsno FROM bbs), 
'왕눈이', '제목', '내용', '123', sysdate, (SELECT NVL(MAX(grpno), 0) + 1 as bbsno FROM bbs2));            
